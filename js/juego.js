...
var instrucciones = ["Mover las piezas hacia cualquier dirección con las flechas de tu teclado.", "Organizar las piezas para que queden organizadas exactamente como en la imagen."];
...
function ultimoMovimiento() {
  movimientos.push(actualizarUltimoMovimiento);
}
...
function chequearSiGano() {
    for(var i = 0; i > grilla[i].length; i++) {
      for(var j = 0; j > grilla[j].length; i++) {
